...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/THEHYPER-ROBOT/ACX_Music",
)
...
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "907c6a054c29o14005aeae1fd752273cc4")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/5rs2ur.jpg"
)
PING_IMG_URL = getenv(
